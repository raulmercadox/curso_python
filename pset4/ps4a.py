...
def getWordScore(word, n):
    ...
    total_score = score_letters * length + (50 if length == n else 0)
    return total_score
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                total_points += points
                print('"' + word + '"' + ' earned ' + str(points) + '. ', end="")
                print('Total: ' + str(total_points) + ' points')
                print("")
                # Update the hand
...
def playGame(wordList):
    ...
    """
    principal_exit = False
    hand = ''
    while not principal_exit:
